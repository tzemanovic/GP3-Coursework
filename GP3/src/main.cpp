...
int main( )
{
	...
	view->setLightDirection( glm::normalize( glm::vec3( 0.0f, 1.0f, 1.0f ) ) );
	view->setAmbientLightColor( glm::vec3( 0.315f, 0.4113f, 0.42f ) );
	...
	g1->setOnUpdate( []( GameObject& gameObject, const Time& time )
	{
		...
		gameObject.rotate( glm::vec3( 1.0f, 1.0f, 0.0f ), time.deltaMs * 0.001f );
	} );
